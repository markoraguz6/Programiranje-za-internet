...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2019 at 03:56 PM
...
CREATE TABLE `flight_details` (
  ...
  `from_city` varchar(20) CHARACTER SET armscii8 DEFAULT NULL,
  `to_city` varchar(20) CHARACTER SET armscii8 DEFAULT NULL,
...
CREATE TABLE `jet_details` (
  ...
  `jet_type` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
